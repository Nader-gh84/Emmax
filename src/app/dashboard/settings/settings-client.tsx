 ...
 * Advance Setting hub.
 *
 * Section sub-nav is intentionally extensible: add new SETTINGS_SECTIONS entries
 * (e.g. permissions, payroll) and render matching panels without growing the
 * Business Profile form further.
 */
...
import { EmployeesSettingsPanel } from "@/components/settings/employees-settings-panel";
import {
  DEFAULT_COUNTRY,
...
/** Advance Setting sections — append here as the hub grows. */
const SETTINGS_SECTIONS = [
  {
    id: "business",
    label: "Business & Quotes",
    description: "Profile, branding, defaults, and PDF templates.",
  },
  {
    id: "employees",
    label: "Employees",
  ...
  return (
    <main className="flex-1 p-4 sm:p-6 lg:p-8">
      <div className="mx-auto w-full max-w-3xl">
        <h1 className="text-2xl font-bold text-white">Advance Setting</h1>
        <p className="mt-2 text-base text-slate-400">
          Business profile, quote templates, employees, and more options as
          you grow the workspace.
        </p>

        <div className="mt-6 overflow-x-auto border-b border-white/10">
          <div className="flex min-w-max gap-1 pb-px" role="tablist">
          ...
          <form onSubmit={handleSubmit} className="mt-8 space-y-8">
            ...
            <section className="space-y-5">
              ...
              <p className="text-sm text-slate-400">
                Used on quote PDFs. Logo upload is not available yet — templates
                use a built-in mark.
              </p>
